...
<!--         			<button class="btn-blueOcen" style="width: 48%">추천 지원자 확인</button> -->
			 ...
			 <c:if test="${proj.projRegist eq authMember.realMember.memId}">
               <button class="btn-grayDay" style="width: 60px; float: right;" data-bs-toggle="modal" data-bs-target="#mymodal" onclick="f_modalOpen()">삭제</button>
               <button onclick="location.href='${cPath }/outsourcing/${proj.projId }/form'" class="btn-blueOcen" style="width: 60px; float: right;">수정</button>
               </c:if>
			<div class="main-body">			
