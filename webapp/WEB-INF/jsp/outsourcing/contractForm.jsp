...
<div id="login" class="ptb ptb-xs-60 page-signin">
            ...
            <div class="card bg-white">
              <div class="card-content">
                <section class="logo text-center">
                  <h2>계약서 작성<input type="checkbox" name="checkbox" id="checkbox" onchange="check1(this)"></h2>
                </section>
                  ...
                  <div class="text-content mt-20">
                   ...
                   <div class="form-group" style="margin-right: 10px; margin-left: 10px;">
                      <div class="ui-input-group">
                        <input type="text" required="" class="form-control" name="contractName" id="contractName">
                   ...
                   <div class="text-content mt-20">
            		...
            		<div class="form-group">
                      <div class="ui-input-group" style="margin-top:0px">
                        <input type="date" required="" class="form-control" name="sdate" id="sdate">
                        <span class="input-bar"></span>
                        <label>계약시작일</label>
                      </div>
                    </div> 
                   ...
                   <div class="text-content mt-20">
            		...
            		<div class="form-group">
                      <div class="ui-input-group" style="margin-top:0px">
                        <input type="number" required="" class="form-control" name="contractPay" id="contractPay">
                        <span class="input-bar"></span>
                        <label>금액</label>
                      </div>
                    </div> 
                    ...
                    <p>원으로 하며 “갑”은 “을”에게 지급하기로 한다.</p><br>
                    </div>
                    </div>
  ...
  var token =  '${_csrf.token}'; 
  	...
  	$("#btn-submit").on("click", function(event) {
  		...
  		sdateDate  = sdateDate > 9 ? sdateDate : "0" + sdateDate;
  	  	...
  	  	contractSdate = sdateYear.toString() + sdateMonth.toString() + sdateDate.toString();
		...
		contractFdate = fdateYear.toString() + fdateMonth.toString() + fdateDate.toString();
  ...
  <script>
    function check1(f){
      if (f.checked) {
        $('#contractName').val('PHOS와 함께하는 계약서');
		$('#sdate').val('2022-09-20');
		$('#fdate').val('2022-10-21');
		$('#contractPay').val('10000000');
        }
      }
    </script>