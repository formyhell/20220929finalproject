...
let makeDiv = function(memRev) {
	console.log("넘어옴");
	console.log(memRev.genrevImg);
	let singleDiv = '';
	singleDiv +='<li class="genRevLi">';
	singleDiv +='<div class="media align-self-center">';
	singleDiv += '<img class="align-self-center" src="${cPath }/resources/images/' + memRev.genrevImg + '">';
