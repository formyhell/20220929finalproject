...
<div class="container">
                      	...
                      	<c:choose>
                      		<c:when test="${not empty pmsList }">
                      			<c:forEach items="${pmsList }" var="pms" varStatus="status">
                      				<tr onclick="openInNewTab('${cPath }/pms/${pms.projId }');" style="cursor : pointer; ">
                      					<td>${status.count}</td>
                      					<td>${pms.projArchi }</td>
			...
			<form:form id="searchForm" modelAttribute="simpleCondition" action="${cPath }/pmsProject/joinProject" method="get">
