...
$(function() {
    function ratingEnable() {
        ...
        $('#u-rating-fontawesome1').barrating({
            theme: 'fontawesome-stars',
            showSelectedRating: false
        });
        $('#u-rating-fontawesome2').barrating({
            theme: 'fontawesome-stars',
            showSelectedRating: false
        });
        $('#u-rating-fontawesome3').barrating({
            theme: 'fontawesome-stars',
            showSelectedRating: false
        });
        
        $('#u-rating-fontawesome4').barrating({
            theme: 'fontawesome-stars',
            showSelectedRating: false
        });
        
        $('#u-rating-fontawesome5').barrating({
            theme: 'fontawesome-stars',
            showSelectedRating: false
        });
        
        $('#u-rating-fontawesome6').barrating({
            theme: 'fontawesome-stars',
            showSelectedRating: false
        });
        
        $('#u-rating-fontawesome7').barrating({
            theme: 'fontawesome-stars',
            showSelectedRating: false
        });
