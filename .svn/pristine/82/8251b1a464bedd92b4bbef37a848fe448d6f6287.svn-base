								...
								<table style="width: 100%; height: 100%;">
									<tr>
										...
										<button onclick="location.href='${cPath }/com/myinfo/${comMember.comId}/form'"
												class="btn btn-pill btn-outline-info btn-xs" style="width: 80px;">수정</button>
										</td>
									...
									<tr>
										...
										<td>${comMember.comNick}</td>
											<td>
									    	<button class="btn btn-pill btn-outline-info btn-xs" style="width: 100px;" data-bs-toggle="modal" data-bs-target="#m_change">비밀번호 변경</button>
									    </td>
...
<!-- 										4 -->
										...
										<p id="grd" style="display:none">${comMember.comGrd}</p>
...
<!-- 									부제목 -->
									...
									<tr>
										...
										<td>
										<button class="btn btn-pill btn-outline-danger btn-xs" style="width: 80px" data-bs-toggle="modal" data-bs-target="#exampleModal">탈퇴</button>
										</td>
									</tr>
								</table>
								</div>
