...
//   @NotBlank
   ...
   private List<CommonCodeVO> outlocList;
   ...
   // 지원자 리스트
   private List<ApplicantVO> applycantList;
...
// 파일 업로드 관련
	...
	private MultipartFile[] outProjFiles;
		
	public void setoutProjFiles(MultipartFile[] boFiles) {
		if(boFiles==null || boFiles.length == 0) return;
		this.outProjFiles = boFiles;
