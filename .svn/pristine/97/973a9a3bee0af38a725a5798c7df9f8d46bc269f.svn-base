...
public interface PortfolioDAO {
	 ...
	 * @return
	 */
	public int selectPfCount(Map<String, Object> map);
	 ...
	 * @return
	 */
	public List<PortfolioVO> selectPfList(Map<String, Object> map);

//	/**
//	 * 아웃소싱 프로젝트 지원자 포트폴리오 수 
//	 * @param map
//	 * @return
//	 */
//	public int applicantPfCount(Map<String, Object> map);
//	
//	/**
//	 * 아웃소싱 프로젝트 지원자 포트폴리오 리스트
//	 * @param map
//	 * @return
//	 */
