		...
		<div class="col-sm-12">
			<div class="card" id="cardBody">
				<div class="card-header">
					<span id="top"><span>BY ${issue.writerName }, </span> <span id="issueDate">${issue.issueDate }</span></span>
					<h5>${issue.issueTitle } 수정</h5>
				</div>
				<sec:authentication property="principal" var="authMember" /> 
				<form:form action="${cPath }/pms/${projId }/issue/${issue.issueId }" modelAttribute="issue" method="post" enctype="multipart/form-data">
					<div class="card-body">
						<div class="form theme-form">
							<form:input path="issueWriter" value="${authMember.realMember.memId }" type="hidden" />
							<form:input path="issueTitle" type="hidden" value="${issue.issueTitle }" class="form-control" />
							<form:input path="issueDate" type="hidden" value="${issue.issueDate }" id='currentDate' class="form-control" />
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="mb-3">
										<label>이슈 상태</label> 
										<form:input path="issueStateName" class="form-control" value="${issue.issueStateName }" readonly="true" />
										<form:input path="issueState" class="form-control" value="${issue.issueState }" type="hidden" readonly="true" />
							...
							<div class="row">
								<div class="col">
									<div class="mb-3">
										<label>이슈 내용</label>
										<form:textarea path="issueContent" class="form-control" id="exampleFormControlTextarea4" rows="3"/>
