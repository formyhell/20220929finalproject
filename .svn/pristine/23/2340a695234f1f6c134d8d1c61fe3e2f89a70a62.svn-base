...
public interface ReportDAO {
	...
	/**
	 * 참여한 프로젝트에서 본인이 작성한 보고서의 수
	 * @param pagingVO
	 * @return
	 */
	public int involveReportTotal(PagingVO<ReportVO> pagingVO);
	
	/**
	 * 참여한 프로젝트에서 본인이 작성 한 보고서
	 * @param pagingVO
	 * @return
	 */
	public List<ReportVO> involveReportList(PagingVO<ReportVO> pagingVO);
