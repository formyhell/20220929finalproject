...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="${cPath}/resources/assetsPms/css/datatables.css">
    <link rel="stylesheet" type="text/css" href="${cPath}/resources/assetsPms/css/owlcarousel.css">
...
<%--     <script src="${cPath}/resources/assetsPms/js/notify/index.js"></script> --%>
    ...
    <script src="${cPath}/resources/assetsPms/js/datatable/datatables/jquery.dataTables.min.js"></script>
    ...
    <script src="${cPath}/resources/assetsPms/js/owlcarousel/owl.carousel.js"></script>
    <script src="${cPath}/resources/assetsPms/js/ecommerce.js"></script>
    <script src="${cPath}/resources/assetsPms/js/product-list-custom.js"></script>
    <!-- Plugins JS Ends-->
    <!-- Theme js-->
