						...
						<div class="form theme-form">
								...
								<div class="col-sm-6">
									<div class="mb-3">
										<div class="mb-3 row">
											...
											<div class="col-sm-9">${issue.issueProj }</div>
										</div>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="mb-3">
										<div class="mb-3 row">
											...
											<div class="col-sm-9">${issue.chargerName }</div>
										</div>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-6">
									<div class="mb-3">
										<div class="mb-3 row">
											<label class="col-sm-3 col-form-label">이슈 일감</label> 
											<div class="col-sm-9">${issue.workTitle }</div>
										</div>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="mb-3">
										<div class="mb-3 row">
											<label class="col-sm-3 col-form-label">이슈 유형</label>
											<div class="col-sm-9">${issue.issueTypeName }</div>
										</div>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-6">
									<div class="mb-3">
										<div class="mb-3 row">
											<label class="col-sm-3 col-form-label">이슈 상태</label> 
											<div class="col-sm-9">${issue.issueStateName }</div>
										</div>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="mb-3">
										<div class="mb-3 row">
											<label class="col-sm-3 col-form-label">이슈 중요도</label> 
											<div class="col-sm-9">${issue.issueImportName }</div>
										</div>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-6">
									<div class="mb-3">
										<div class="mb-3 row">
											<label class="col-sm-3 col-form-label">일감의 관리자</label> 
											<div class="col-sm-9">${issue.workManagerName }</div>
										</div>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="mb-3">
										<div class="mb-3 row">
											<label class="col-sm-3 col-form-label">일감의 담당자</label> 
											<div class="col-sm-9">${issue.workChargerName }</div>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="row">
									<div class="col">
										<div class="mb-3">
											...
											<pre class="yu_div_css" style="background-color: white;">${solve.solveContent }</pre>
										</div>
									</div>
								</div>
							</c:if>
...
// 	send("진짜 마지막이다??","test4ID","pms/PMS2208040001/issue/IS2209030001");
